...
#独立测试各个物种：
wheat_filepath= "../Csv/speices_train_test/wheat_test.csv"
papaya_filepath= "../Csv/speices_train_test/papaya_test.csv"
peanut_filepath= "../Csv/speices_train_test/peanut_test.csv"
rice_filepath= '../Csv/speices_train_test/rice_test.csv'
tabacum_filepath= "../Csv/speices_train_test/tabacum_test.csv"
