...
def RF_Classifer(train_data,ind_test_data):
    ...
    for train_index,valid_index in kf.split(X_train,y_train):
        ...
        rf_clf.fit(this_train_x,this_train_y)

        # train fit
        y_train_pred=rf_clf.predict(this_train_x)

        # valid fit
        y_valid_pred=rf_clf.predict(this_valid_x)
        ...
        y_score.append(rf_clf.predict_proba(this_valid_x)[:,1])
